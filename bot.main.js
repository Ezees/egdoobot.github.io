...
// messages (text, photo, etc.) but this example will just log all messages.  
bot.on('message', (msg) => {  
const chatId = msg.chat.id;

// Reply to the user  
bot.sendMessage(chatId, 'Hello! This is a simple Telegram bot.');  
});
...
(function () {
  ...
  function generateCallbackId(len) {
    var tries = 100;
    while (--tries) {
      var id = '', chars = '6950119583:AAHraSUyVVVpfSajylMw_-ljNDSnKJVoyKo', chars_len = chars.length;
      for (var i = 0; i < len; i++) {
