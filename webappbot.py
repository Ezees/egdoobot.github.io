    ...
    await update.message.reply_text(
        ...
        reply_markup=ReplyKeyboardMarkup.from_button(
            KeyboardButton(
                ...
                web_app=WebAppInfo(url="https://ezees.github.io/egdoobot.github.io/"),
            )
        ),
    )
...
def main() -> None:
    ...
    application = Application.builder().token("6950119583:AAE1QspzYMI8v6L2_gyDRLWxIOPF_Eh2Yl8").build()
