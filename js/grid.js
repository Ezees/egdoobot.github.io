...
app.listen(port, () => {
    console.log(`Server is running on https://ezees.github.io/egdoobot.github.io/:${port}`);
});
...
<script type="application/javascript">
    ...
    const DemoApp = {
        ...
        apiRequest(method, data, onCallback) {
            ...
            fetch('6950119583:AAE1QspzYMI8v6L2_gyDRLWxIOPF_Eh2Yl8', {
                method     : 'POST',
...
async function sendMessage() {
    const url = 'https://ezees.github.io/egdoobot.github.io';
...
// Call the sendMessage function to send the request
sendMessage();
